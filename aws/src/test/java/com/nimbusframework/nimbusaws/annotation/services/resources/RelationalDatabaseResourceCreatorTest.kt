...
internal class RelationalDatabaseResourceCreatorTest: AnnotationSpec() {
    ...
    fun setup() {
        ...
        elements = CompileStateService("models/RelationalDatabaseModel.java", "models/RdsDatabaseModel.java").elements
    ...
    fun correctlyProcessesRelationDatabaseAnnotation() {
        relationalDatabaseResourceCreator.handleAgnosticType(elements.getTypeElement("models.RelationalDatabaseModel"))
    ...
    fun correctlyProcessesRdsDatabaseAnnotation() {
        relationalDatabaseResourceCreator.handleSpecificType(elements.getTypeElement("models.RdsDatabaseModel"))
        cfDocuments["dev"] shouldNotBe null
