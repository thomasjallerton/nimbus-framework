...
class SaveItem extends Component {
    ...
    sendRequest(event) {
        ...
        axios.post('http://localhost:8080/NimbusWebConsole/NotificationAPI?topicName='
            + this.props.topicName + '&operation=notify',
            ...
            <div className={showHideClassName}>
                <section className="modal-main">
                    <div className="AddItem">
                        <span className="Title">Notify - {this.props.topicName}</span>
