...
import './KeyValueStorePage.css';
import axios from 'axios'
import {KeyValueStoreItems} from "./KeyValueStoreItems";
import SaveItem from "./SaveItem"

export class KeyValueStorePage extends React.Component {
    ...
    getItems() {
        axios.get('http://localhost:8080/NimbusWebConsole/KeyValueStoreAPI?tableName='
    ...
    delete = () => {
        this.state.selectedItems.map(item => {
            if (item.selected) {
                ...
                axios.post('http://localhost:8080/NimbusWebConsole/KeyValueStoreAPI?tableName='
