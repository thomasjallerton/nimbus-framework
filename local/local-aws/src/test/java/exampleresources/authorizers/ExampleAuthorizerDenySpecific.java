...
public class ExampleAuthorizerDenySpecific implements ApiGatewayLambdaAuthorizer {
    ...
    public IamPolicyResponse handleRequest(APIGatewayCustomAuthorizerEvent input, Context context) {
        ...
        String resource = "arn:aws:execute-api:" + methodArn[3] + ":" + methodArn[4] + ":" + path[0] + "/" + path[1] + "/*";
        String denyResource = "arn:aws:execute-api:" + methodArn[3] + ":" + methodArn[4] + ":" + path[0] + "/" + path[1] + "/GET/hello/world";
                ...
                .withPolicyDocument(
                        IamPolicyResponse.PolicyDocument.builder()
                                ...
                                .withStatement(List.of(
                                        IamPolicyResponse.denyStatement(denyResource),
