...
class SaveItem extends Component {
    ...
    sendRequest(event) {
        ...
        axios.post('http://localhost:8080/NimbusWebConsole/QueueAPI?queueName='
            + this.props.queueName + '&operation=pushItem',
            ...
            <div className={showHideClassName}>
                <section className="modal-main">
                    <div className="AddItem">
                        <span className="Title">New Item - {this.props.queueName}</span>
